...
// initializing the ICE Server with the help of TURN / STUN Server.
    getIceServer() {
        return {
            iceServers: [{
                ...
                username: "s5kC4A0nn2wqmOqoZ83bIrJxHCayiQKNJC89vtCrMVkEI8G6jNWgeqkqEvedJ57RAAAAAGXdq2hha3No",
                credential: "aaad175a-d552-11ee-9753-0242ac140004",
                urls: [
    ...
    addChat(data, senderType) {
         ...
         * Move focus to the newly added message but only if:
         * 1. Page has focus
         * 2. User has not moved scrollbar upward. This is to prevent moving the scroll position if the user is reading previous messages.
         */
        if (this.pageHasFocus) {
            rowDiv.scrollIntoView();
        }
